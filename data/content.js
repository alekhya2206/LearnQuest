...
// ARIA Assessment Questions
export const ARIA_QUESTIONS = [
  {
    id: 1,
    question: "When you encounter a new system or concept, what's your first instinct?",
    options: [
      { icon: '📖', label: 'Read the rules first', desc: 'Understand the structure before diving in' },
      { icon: '🚀', label: 'Experiment freely', desc: 'Jump in and learn by doing' },
      { icon: '🔗', label: 'Find existing patterns', desc: 'Connect it to what I already know' },
      { icon: '💬', label: 'Ask an expert', desc: 'Get a shortcut from someone experienced' },
    ]
  },
  {
    id: 2,
    question: "How comfortable are you reasoning with abstract symbols and notation you've never seen before?",
    options: [
      { icon: '😰', label: 'Very uncomfortable', desc: 'I need concrete examples first' },
      { icon: '😐', label: 'Somewhat okay', desc: 'I can manage with some context' },
      { icon: '😊', label: 'Pretty comfortable', desc: 'I can reason through it methodically' },
      { icon: '🧠', label: 'Love it', desc: 'Abstract thinking energizes me' },
    ]
  },
  {
    id: 3,
    ...
    options: [
      { icon: '🗺️', label: 'Plan extensively', desc: 'Map everything out before coding' },
      { icon: '⚡', label: 'Iterate quickly', desc: 'Build fast, fix fast' },
      { icon: '📊', label: 'Gather data first', desc: 'Analyze before deciding' },
      { icon: '🎯', label: 'Focus on the core', desc: 'Solve the hardest part first' },
    ]
  },
  {
    id: 4,
    question: "Which describes your learning style best?",
    options: [
      { icon: '👁️', label: 'Visual', desc: 'Diagrams, charts, and visualizations' },
      { icon: '📝', label: 'Textual', desc: 'Written explanations and documentation' },
      { icon: '🛠️', label: 'Hands-on', desc: 'Projects and real experiments' },
      { icon: '🎵', label: 'Narrative', desc: 'Stories and real-world analogies' },
    ]
  },
  {
    id: 5,
    question: "How much prior experience do you have with mathematics and statistics?",
    options: [
      { icon: '🌱', label: 'Beginner', desc: 'Basic algebra, not much beyond that' },
      { icon: '📐', label: 'Intermediate', desc: 'Calculus and some statistics' },
      { icon: '🔬', label: 'Advanced', desc: 'Linear algebra, probability theory' },
      { icon: '🎓', label: 'Expert', desc: 'Graduate-level mathematics' },
    ]
  },
  {
    id: 6,
    question: "When a concept doesn't immediately make sense, you typically:",
    options: [
      { icon: '🔄', label: 'Try again differently', desc: 'Approach it from a new angle' },
      { icon: '⏩', label: 'Move on first', desc: 'Come back later with fresh eyes' },
      { icon: '🔍', label: 'Dig deeper', desc: 'Research until it clicks' },
      { icon: '👥', label: 'Discuss it', desc: 'Talk it through with others' },
    ]
  },
  {
    id: 7,
    question: "What is your primary goal with Machine Learning?",
    options: [
      { icon: '💼', label: 'Career change', desc: 'Land a ML/AI role' },
      { icon: '🔬', label: 'Research', desc: 'Conduct academic or scientific research' },
      { icon: '🏗️', label: 'Build products', desc: 'Create AI-powered applications' },
      { icon: '🌍', label: 'Curiosity', desc: 'Understand how AI actually works' },
    ]
  },
];

// ARIA profile results
export const ARIA_PROFILES = [
  { label: 'Visual Systems Thinker', tier: 'Intermediate', desc: "You process information through structure and patterns. You'll thrive with visual roadmaps and conceptual diagrams. Starting you at Intermediate — your pattern recognition is a superpower." },
  { label: 'Analytical Deep Diver', tier: 'Advanced', desc: "You love getting to the root of things. Strong mathematical comfort and methodical thinking put you at Advanced — we'll skip the basics and get to the good stuff." },
  { label: 'Hands-On Builder', tier: 'Beginner', desc: "You learn best by building. We'll start at Beginner with a project-first approach — every concept gets a real implementation to anchor it." },
];
